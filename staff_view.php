			...
			<div class="tab-content " id="v-pills-tabContent">
			  <div class="tab-pane fade show active" id="v-pills-item" role="tabpanel" aria-labelledby="v-pills-item-tab">
				<div class="card card-outline-secondary my-4"><h3>
				  <div class="card-header btn-primary" style="padding-left:30%;margin:30px">Staff panel to view the daily appointments</div></h3>
...
-->
			  ...
			  <div class="tab-pane" id="v-pills-reports" role="tabpanel" aria-labelledby="v-pills-reports-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header"> <button id="reportsTablesRefresh" name="reportsTablesRefresh" class="btn btn-warning float-right btn-sm">Refresh</button></div>
				  <div class="card-body bg-success text-dark">										
					...
					<div class="tab-content">
						<div id="itemReportsTab" class="container-fluid tab-pane active" style="background-color:darkcyan">
							<br>
 							<div class="table-responsive" id="itemReportsTableDiv1"></div>
                            <?php
	require 'staff_data.php';
?>
						</div>
					</div>
				  </div> 
